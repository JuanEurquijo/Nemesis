<template>
    <header class="flex items-center justify-between border-b-4 border-cyan-700 bg-white px-6 py-4">
        <div class="flex items-center">
            <button @click="$page.props.showingMobileMenu = !$page.props.showingMobileMenu" class="text-gray-500 focus:outline-none lg:hidden" aria-label="Navigation Menu Button">
