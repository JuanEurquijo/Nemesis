        ...
        <div class="mt-6 sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex items-center mt-4 gap-x-4 sm:mt-0">
                <a v-if="standards.current_page > 1" :href="searchQuery.trim() !== '' ? null : standards.prev_page_url"
                    ...
                    class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-gray-800 text-white border rounded-md sm:w-auto gap-x-2 hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
