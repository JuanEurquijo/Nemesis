<template>
    ...
    <AppLayout>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Aquí puede encontrar todos los medicamentos para
                    recetar.</p>
            </div>
        ...
        <div class="text-sm text-gray-500 dark:text-gray-400">
            Página <span class="font-medium text-gray-700 dark:text-gray-100">{{ medicines.current_page }} de {{ medicines.last_page }}</span> 
        </div>

        <div class="flex items-center mt-4 gap-x-4 sm:mt-0">
            <a v-if="medicines.current_page > 1" :href="medicines.prev_page_url" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-white border rounded-md sm:w-auto gap-x-2 hover:bg-gray-100 dark:bg-gray-900 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-800">
            ...
            <a v-if="medicines.current_page < medicines.last_page" :href="medicines.next_page_url" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-white border rounded-md sm:w-auto gap-x-2 hover:bg-gray-100 dark:bg-gray-900 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-800">
                <span>
                    Next
                </span>
